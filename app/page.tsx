...
import { Mic2, Activity, Clapperboard, ArrowRight, DollarSign } from "lucide-react";
import { getSessionKey } from "@/lib/auth"; // ✨ 改用我们自己的验证库
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-end">
        <div>
          {/* 显示卡密名称 */}
          <h1 className="text-3xl font-bold text-slate-800">早安，{key || "VIP用户"} 👋</h1>
